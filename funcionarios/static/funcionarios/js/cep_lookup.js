...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (cepInput) {
        ...
        cepInput.addEventListener('blur', function () {
            console.log(
                'Pista 4: Evento BLUR disparado! O usuário saiu do campo CEP.',
            );
                ...
                fetch(`https://viacep.com.br/ws/${cep}/json/`)
                    ...
                    .then((data) => {
                        if (!data.erro) {
                            ...
                            console.log(
                                'API retornou um erro: CEP não encontrado.',
                            );
        ...
        console.error(
            'ERRO CRÍTICO: Campo com id="id_cep" NÃO foi encontrado no DOM.',
        );
    }
});
