...
class Escala(models.Model):
    ...
    prioritaria = models.BooleanField(


        default=False, verbose_name="Escala Prioritária (Trabalha em Feriados)"
...
class Feriado(models.Model):
    ...
    recorrente = models.BooleanField(
        ...
        help_text="Marque se for um feriado que se repete anualmente (ex: Natal). O ano da data será ignorado.",
